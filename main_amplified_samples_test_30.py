...
def train(args):
    ...
    for func in args.func:
        ...
        for data_source in args.data:
            ...
            model_path = './data_collect/amplify_samples/model/'+func+'/30/'+data_source+'_'+func+'_'+args.net+'_'+str(args.hidden_dim)+'_'+args.pool+'_'+str(args.dropout)+'_'+str(args.threshold)+'.pkl'
